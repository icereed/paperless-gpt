...
- Re-applying a document is duplicate-protected by searching for likely existing transactions before creating; if that duplicate check cannot be completed, Paperless GPT aborts the create instead of risking a duplicate.

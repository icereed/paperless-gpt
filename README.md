...
| `TAGS_OWNER`                        | The owner of new tags. Default: `user`, the paperless-gpt user. `none` will assign no user, which makes tags global. `document` will assign the owner of the document.                        | No       | user                       |
